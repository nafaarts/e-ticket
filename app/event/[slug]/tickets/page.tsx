  ...
  return (
    <main className="mx-auto max-w-7xl p-2 md:p-4">
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="sticky md:top-[80px] w-full md:w-[400px] h-fit">
          <div className="bg-white md:p-5 p-3 rounded-md">
            ...
            <h5 className="text-right text-xl font-bold mb-4">Rp. 1.000.000</h5>

            <Link href="/event/this-is-sample-event/personal-information">
